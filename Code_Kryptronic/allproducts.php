...
<nav id="wish_list">
  <ul>
    ...
    <li><button type="button" class="profilebtn"><a href = "profilepage.html"><img src="profileicon.png" alt="profileico" style = "display:inline" width="30" height="30"></a></button></li>
  </ul>
</nav>
...
$sql = "SELECT catagory_id, prod_name, price, prod_location FROM catagories WHERE catagory_id =$id " ;
